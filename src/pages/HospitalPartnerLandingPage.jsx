      ...
      <section id="hpl-reviews" style={{ padding: '44px 16px', background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
        <div className="hpl-container">
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px', marginBottom: '24px' }}>
            <div>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '4px 12px', background: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '16px', marginBottom: '8px' }}>
                ...
                <span style={{ fontSize: '0.8rem', fontWeight: 800, color: '#0f172a' }}>Google Reviews</span>
                <div style={{ color: '#FBBC05', fontSize: '0.82rem', display: 'flex', gap: '1px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(1.35rem, 2.2vw, 1.85rem)', fontWeight: 800, color: '#0f172a', margin: 0 }}>
                ...
                <div key={`${review.id}-${offset}`} className={`hpl-google-review-card ${offset === 1 ? 'hpl-review-card-second' : ''}`}>
                  <div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '10px', marginBottom: '10px' }}>
                      <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                        <div style={{ position: 'relative' }}>
                          <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: review.avatarBg, color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, fontSize: '0.95rem' }}>
                            {review.initials}
                          </div>
                        ...
                        <div>
                          <h4 style={{ fontSize: '0.95rem', fontWeight: 800, color: '#0f172a', margin: 0, lineHeight: 1.25 }}>{review.author}</h4>
                          <span style={{ fontSize: '0.78rem', color: '#0052cc', fontWeight: 700, display: 'block' }}>{review.title}</span>
                          <span style={{ fontSize: '0.72rem', color: '#64748b', fontWeight: 600 }}>{review.hospital}</span>
                        </div>
                      </div>
                    ...
                    <div style={{ position: 'relative', margin: '8px 0 12px' }}>
                      <p style={{ fontSize: '0.86rem', color: '#334155', lineHeight: 1.55, fontStyle: 'italic', margin: 0 }}>
