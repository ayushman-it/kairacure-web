...
export function PartnerDetailPage({ money, selectedHospital, selectedTreatment, setPage, setSelectedHospital, onBack }) {
  ...
  return (
    <section className="page-section partner-detail-landing">
      ...
      {/* CONTAINER ALIGNED 100% WITH HEADER NAVBAR */}
      <div className="bootstrap-hospital-wrap">
        ...
        <div className="card border-0 shadow-sm rounded-3 p-3 p-md-3.5 mb-3" style={{ background: '#ffffff' }}>
          <div className="row g-3.5 align-items-center">

            {/* Left Image & Gallery */}
            <div className="col-lg-5 col-md-6">
              <div className="position-relative rounded-2 overflow-hidden border mb-2" style={{ height: '210px' }}>
                ...
                {/* SMALL COMPACT BADGE */}
                <span className="position-absolute top-0 start-0 m-2 px-2 py-0.5 bg-dark bg-opacity-85 text-white rounded-1 fs-8 fw-semibold">
                  <i className="fa-solid fa-shield-halved text-info me-1" /> Verified Partner
                </span>
              </div>
              <div className="d-flex gap-1.5">
                {gallery.slice(0, 4).map((img, i) => (
                  <img key={i} src={img} alt="Preview" className="rounded-1 border object-fit-cover" style={{ width: '52px', height: '36px' }} />
                ))}
              </div>
            </div>
            ...
            <div className="col-lg-7 col-md-6">
              ...
              <div className="d-flex flex-wrap gap-1.5 mb-2">
                <span className="badge bg-primary-subtle text-primary border border-primary-subtle fw-semibold px-2 py-0.5 rounded-1 fs-8">
                  {hospital.specialty || 'Multispecialty'} Hospital
                </span>
                <span className="badge bg-warning-subtle text-warning-emphasis border border-warning-subtle fw-semibold px-2 py-0.5 rounded-1 fs-8">
              ...
              <div className="bg-light p-2.5 rounded-2 border mb-3">
                <div className="d-flex align-items-start gap-2">
                  <i className="fa-solid fa-location-dot text-danger mt-1 fs-7" />
                  <div>
                    <strong className="d-block text-dark fs-7 fw-semibold mb-0.5">
                      {hospital.city ? `${hospital.city}, ${hospital.state || ''} ${hospital.country || 'India'}` : hospitalAddress}
                    </strong>
                    <span className="text-secondary fs-8 d-block leading-normal mb-1.5">
                      {hospitalAddress}
                    </span>
                    <div className="d-flex flex-wrap gap-1.5 align-items-center">
                      <span className="badge bg-white text-secondary border fs-8 fw-normal px-2 py-0.5 rounded-1">
                        <i className="fa-solid fa-plane-arrival me-1 text-primary" /> International Terminal Access
                      </span>
                      <span className="badge bg-white text-secondary border fs-8 fw-normal px-2 py-0.5 rounded-1">
                        <i className="fa-solid fa-hospital-user me-1 text-success" /> Care Concierge Desk
                      </span>
                    </div>
                  </div>
                </div>
              ...
              {/* Spec Pills Bar */}
              <div className="row row-cols-4 g-1 bg-light p-2 rounded-2 border text-center mb-3">
                <div className="col">
                  <span className="d-block fw-bold text-dark fs-7">{hospitalBeds}</span>
                  <span className="text-muted fs-8">Capacity</span>
                </div>
                <div className="col">
                  <span className="d-block fw-bold text-dark fs-7">{hospital.doctors || '45+'}</span>
                  <span className="text-muted fs-8">Doctors</span>
                </div>
                <div className="col">
                  <span className="d-block fw-bold text-dark fs-7">{hospitalFounded}</span>
                  <span className="text-muted fs-8">Established</span>
                </div>
                <div className="col">
                  <span className="d-block fw-bold text-success fs-7">{hospital.rating || '4.9'} ★</span>
              ...
              <div className="d-flex flex-wrap gap-2">
                <a href="#connect-form" className="btn btn-primary fw-semibold px-3 py-1.5 rounded-2 fs-7 shadow-sm">
                  <i className="fa-solid fa-calendar-check me-1" /> Book Free Consultation
                </a>
                <button onClick={() => setPage('planner')} type="button" className="btn btn-outline-primary fw-semibold px-3 py-1.5 rounded-2 fs-7">
                  <i className="fa-solid fa-calculator me-1" /> Journey Cost Calculator
                </button>
              </div>
        ...
        {/* NAVIGATION TABS */}
        <div className="bg-white rounded-top-3 border-bottom px-3 pt-2 mb-3">
            ...
            {[
              ...
              <li className="nav-item" key={tabKey}>
                <button
                  ...
                  className={`nav-link border-0 text-nowrap py-2 px-3 fs-7 fw-semibold ${activeTab === tabKey ? 'active border-bottom border-3 border-primary text-primary fw-bold' : 'text-secondary'}`}
                >
                  {tabLabel}
                </button>
              </li>
        ...
        <div className="row g-3">
          ...
          <div className="col-lg-8">
            ...
            {(activeTab === 'overview' || activeTab === 'all') && (
              <div className="card border-0 shadow-sm rounded-3 p-3.5 mb-3" style={{ background: '#ffffff' }}>
                <h3 className="fs-6 fw-bold text-dark mb-2">
                  Infrastructure & Portfolio Highlights
                </h3>
                <p className="text-secondary fs-7 leading-relaxed mb-3">
                ...
                <div className="row g-2.5">
                  <div className="col-md-4">
                    <div className="p-2.5 bg-light rounded-2 border h-100">
                      <i className="fa-solid fa-microscope text-primary fs-5 mb-1.5" />
                      <strong className="d-block text-dark fs-7 mb-0.5">Advanced Diagnostics</strong>
                  ...
                  <div className="col-md-4">
                    <div className="p-2.5 bg-light rounded-2 border h-100">
                      <i className="fa-solid fa-bed-pulse text-primary fs-5 mb-1.5" />
                      <strong className="d-block text-dark fs-7 mb-0.5">ICU & Critical Care</strong>
                  ...
                  <div className="col-md-4">
                    <div className="p-2.5 bg-light rounded-2 border h-100">
                      <i className="fa-solid fa-globe text-primary fs-5 mb-1.5" />
                      <strong className="d-block text-dark fs-7 mb-0.5">International Lounge</strong>
                ...
                <div className="row g-2.5">
                  {hospitalTreatments.map((t, idx) => (
                    <div key={idx} className="col-md-6">
                      <div className="p-2.5 bg-light rounded-2 border h-100 d-flex flex-column justify-content-between">
                        <div>
                          <span className="badge bg-primary-subtle text-primary border border-primary-subtle fw-semibold fs-8 px-2 py-0.5 rounded-1 mb-1">{t.specialty || 'Specialty'}</span>
                          <h4 className="fs-7 fw-bold text-dark mb-1">{t.title}</h4>
                        ...
                        <div className="d-flex justify-content-between align-items-center mt-2 pt-2 border-top">
                          <div>
                            ...
                            <strong className="text-dark fs-7">{money(t.packageFrom)}</strong>
                          </div>
                          <a href="#connect-form" className="btn btn-sm btn-primary fw-semibold px-2.5 py-1 rounded-1 fs-8">
                            Enquire
                          </a>
                        </div>
                      </div>
                ...
                <div className="row g-2.5">
                  {hospitalDoctors.map((doc, idx) => (
                    <div key={idx} className="col-md-4">
                      <div className="p-2.5 border rounded-2 text-center bg-white h-100 d-flex flex-column justify-content-between">
                        <div>
                          <div className="bg-primary-subtle text-primary rounded-circle mx-auto mb-2 d-grid place-items-center" style={{ width: '48px', height: '48px', fontSize: '1.25rem' }}>
                            <i className="fa-solid fa-user-doctor" />
                          </div>
                          <h4 className="fs-7 fw-bold text-dark mb-0.5">{doc.name}</h4>
                        ...
                        <a href="#connect-form" className="btn btn-sm btn-outline-secondary fw-semibold w-100 fs-8 py-1 rounded-1">
                          Book Slot
                        </a>
                      </div>
                    </div>
            ...
            {(activeTab === 'reviews' || activeTab === 'overview') && (
              <div className="card border-0 shadow-sm rounded-3 p-3.5 mb-3" style={{ background: '#ffffff' }}>
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h3 className="fs-6 fw-bold text-dark mb-0">Patient Reviews & Ratings</h3>
                  <span className="badge bg-warning-subtle text-warning-emphasis border border-warning-subtle px-2.5 py-1 rounded-1 fs-8 fw-bold">
                ...
                <div className="row g-2.5">
                  <div className="col-md-6">
                    <blockquote className="p-2.5 bg-light rounded-2 border mb-0">
                      <p className="fst-italic text-secondary fs-8 mb-2">
                      ...
                      <strong className="d-block text-dark fs-8">Ahmed Al-Hassan</strong>
                  ...
                  <div className="col-md-6">
                    <blockquote className="p-2.5 bg-light rounded-2 border mb-0">
                      ...
                      <strong className="d-block text-dark fs-8">Grace Wanjiku</strong>
            ...
            {(activeTab === 'faqs' || activeTab === 'overview') && (
              <div className="card border-0 shadow-sm rounded-3 p-3.5 mb-3" style={{ background: '#ffffff' }}>
                ...
                <div className="accordion accordion-flush" id="hospitalFaqAccordion">
                  {faqs.map((faq, i) => (
                    <div key={i} className="accordion-item border rounded-2 mb-2 overflow-hidden">
                      <h2 className="accordion-header">
                        <button className="accordion-button collapsed fw-semibold text-dark fs-7 py-2 px-3" type="button" data-bs-toggle="collapse" data-bs-target={`#faq-${i}`}>
                          {faq.q}
                        </button>
                      </h2>
                      <div id={`faq-${i}`} className="accordion-collapse collapse" data-bs-parent="#hospitalFaqAccordion">
                        <div className="accordion-body text-secondary fs-8 pt-1 pb-2.5 px-3">
                          {faq.a}
                        </div>
                      </div>
                    </div>
          ...
          <div className="col-lg-4">
            <div id="connect-form" className="card border-0 shadow-sm rounded-3 p-3.5 sticky-top" style={{ top: '1.25rem', background: '#ffffff' }}>
              <div className="text-center mb-3">
                <h3 className="fs-6 fw-bold text-dark mb-1">Book Free Consultation</h3>
                <p className="text-muted fs-8 mb-0">Doctor opinion & starting quote within 2 hours</p>
              </div>

              {formSubmitted ? (
                <div className="p-3 bg-success-subtle text-success-emphasis border border-success-subtle rounded-2 text-center">
                  <i className="fa-solid fa-circle-check fs-3 text-success mb-2" />
                  <h4 className="fs-7 fw-bold mb-1">Request Received!</h4>
                ...
                <form onSubmit={handleLeadSubmit} className="d-flex flex-column gap-2">
                  <div>
                    ...
                    <input type="text" required placeholder="Enter full name" value={leadForm.name} onChange={(e) => setLeadForm({ ...leadForm, name: e.target.value })} className="form-control form-control-sm fs-8" />
                  </div>
                  <div>
                    <label className="form-label text-dark fs-8 fw-semibold mb-1">Phone / WhatsApp Number *</label>
                    <input type="tel" required placeholder="+91 99999 99999" value={leadForm.phone} onChange={(e) => setLeadForm({ ...leadForm, phone: e.target.value })} className="form-control form-control-sm fs-8" />
                  </div>
                  <div>
                    <label className="form-label text-dark fs-8 fw-semibold mb-1">Email Address</label>
                    <input type="email" placeholder="patient@example.com" value={leadForm.email} onChange={(e) => setLeadForm({ ...leadForm, email: e.target.value })} className="form-control form-control-sm fs-8" />
                  </div>
                  <div>
                    <label className="form-label text-dark fs-8 fw-semibold mb-1">Medical Issue / Specialty</label>
                    <input type="text" placeholder="e.g. IVF, Knee replacement..." value={leadForm.treatment} onChange={(e) => setLeadForm({ ...leadForm, treatment: e.target.value })} className="form-control form-control-sm fs-8" />
                  </div>
                  <button type="submit" className="btn btn-primary fw-semibold w-100 py-1.5 fs-7 mt-1 shadow-sm rounded-1">
